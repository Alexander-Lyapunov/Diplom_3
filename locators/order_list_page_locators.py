...
class OrderListPageLocators:
    ...
    ORDERS_ALL_TIME = (By.XPATH, '//p[text()="Выполнено за все время:"]/following-sibling::p[contains(@class,"digits-large")]') #количество выполненных заказов (за все время)
    ORDERS_TODAY = (By.XPATH, '//p[text()="Выполнено за сегодня:"]/following-sibling::p[contains(@class,"digits-large")]') #количество выполненных заказов (за сегодня)
